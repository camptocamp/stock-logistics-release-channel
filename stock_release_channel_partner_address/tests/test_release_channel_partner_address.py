...
class TestReleaseChannelPartnerAddress(ReleaseChannelCase):
    ...
    def test_00_picking_find_release_channel_match_by_address_no_country_no_state(self):
    ...
    def test_01_picking_find_release_channel_match_by_address_country_no_state(self):
        move = self._create_single_move(self.product1, 5)
    ...
    def test_02_picking_find_release_channel_match_by_address_country_and_state(self):
        move = self._create_single_move(self.product1, 5)
